...
class Application_Model_InscriptionEvenementMapper {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_InscriptionEvenement');
        }
    ...
    public function findAll($params = array(), $order = NULL) {
        ...
        $select->setIntegrityCheck(false)
                ->from(array('ie' => 'inscription_evenement'), array('ie.*'))
                ->join(array('u' => 'user'), 'ie.id_user = u.id', array('u.*'))
                ->group('id_evenement')
        ; //print_r($params);
